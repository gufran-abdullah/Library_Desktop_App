...
namespace Library_Management
{
    public partial class mdi_user : Form
    {
        ...
        private void viewBooksRecordToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void viewStudentsRecordToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void retainedBooksReportToolStripMenuItem_Click(object sender, EventArgs e)
        {
            report_retained_books rrb = new report_retained_books();
            rrb.Show();
        }
